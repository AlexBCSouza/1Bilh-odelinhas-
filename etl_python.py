...
def processar_temperaturas(path_do_txt: Path):
    ...
    print("Dados carregados.  Calculo estatístico...")

    # dicionario para armazenamento de resultados calculados
    results = {} 
    ...
    formatted_results = {
    station: f"{min_temp:.1f}/{mean_temp:.1f}/{max_temp:.1f}"for station, (min_temp, mean_temp, max_temp) in sorted_results.items()}
